...
@RestController
@RequestMapping("/api/score-kafka")
public class ScoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ScoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ScoreKafkaResource(KafkaProperties kafkaProperties) {
