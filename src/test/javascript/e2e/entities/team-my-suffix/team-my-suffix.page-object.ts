...
export class TeamComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-team-my-suffix div table .btn-danger'));
  title = element.all(by.css('jhi-team-my-suffix div h2#page-heading span')).first();
...
export class TeamUpdatePage {
  pageTitle = element(by.id('jhi-team-my-suffix-heading'));
