...
class TeamResourceIT {
     ...
     *
     * @see com.sport.score.repository.search.TeamSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().name(DEFAULT_NAME).picture(DEFAULT_PICTURE).pictureContentType(DEFAULT_PICTURE_CONTENT_TYPE);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().name(UPDATED_NAME).picture(UPDATED_PICTURE).pictureContentType(UPDATED_PICTURE_CONTENT_TYPE);
        return team;
    }
    ...
    void putNewTeam() throws Exception {
        ...
        updatedTeam.name(UPDATED_NAME).picture(UPDATED_PICTURE).pictureContentType(UPDATED_PICTURE_CONTENT_TYPE);
        ...
        // Validate the Team in Elasticsearch
        verify(mockTeamSearchRepository).save(testTeam);
    }
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.name(UPDATED_NAME).picture(UPDATED_PICTURE).pictureContentType(UPDATED_PICTURE_CONTENT_TYPE);
    ...
    void searchTeam() throws Exception {
        ...
        // Initialize the database
        teamRepository.saveAndFlush(team);
        when(mockTeamSearchRepository.search("id:" + team.getId(), PageRequest.of(0, 20)))
